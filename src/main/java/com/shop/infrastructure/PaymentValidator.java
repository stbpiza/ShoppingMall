...
import com.shop.infrastructure.dtos.PortonePaymentDto;
import com.shop.infrastructure.dtos.PortoneTokenRequestDto;
import com.shop.infrastructure.dtos.PortoneTokenResultDto;
...
public class PaymentValidator {
    ...
    public void validate(Payment payment, Order order) {
        ...
        try {
            ...
            // 2. 결제 정보 얻기
            amount = fetchPaymentAmount(payment, accessToken);
        } catch (Exception e) {
            amount = order.totalPrice().asLong();
        }
